...
def main():
    ...
    st.markdown(""" Hello! I am an OpenAI powered assistant called AI Feature Doc Pro. My job is to create help center documentation for your features. Example: Create documentation for AI Feature Doc Pro
    """)    
